...
LABEL org.opencontainers.image.title="Open Security" \
      org.opencontainers.image.description="Noninteractive, resumable Open Security CSV repository scans" \
      org.opencontainers.image.source="https://github.com/masonjames/open-security"
...
ENV CODEX_HOME=/state \
    ...
    OPEN_SECURITY_STATE_DIR=/output/.codex-security-state \
