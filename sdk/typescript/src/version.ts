...
export const OPEN_SECURITY_NPM_REGISTRY_ENV =
  "OPEN_SECURITY_NPM_REGISTRY" as const;

const PACKAGE_NAME = PACKAGE_VERSIONS.name;
const LEGACY_NO_UPDATE_NOTICE_ENV = "CODEX_SECURITY_NO_UPDATE_NOTICE";
const LEGACY_NPM_REGISTRY_ENV = "CODEX_SECURITY_NPM_REGISTRY";
...
export function updateNoticeEnabled(environment: NodeJS.ProcessEnv): boolean {
  return (
    environment[OPEN_SECURITY_NO_UPDATE_NOTICE_ENV] === undefined &&
    environment[LEGACY_NO_UPDATE_NOTICE_ENV] === undefined &&
...
export async function checkForUpdate({
  ...
  try {
    const registry =
      firstNonBlankEnvironment(environment, [
        OPEN_SECURITY_NPM_REGISTRY_ENV,
        LEGACY_NPM_REGISTRY_ENV,
        "npm_config_registry",
        "NPM_CONFIG_REGISTRY",
...
function firstNonBlankEnvironment(
  environment: NodeJS.ProcessEnv,
